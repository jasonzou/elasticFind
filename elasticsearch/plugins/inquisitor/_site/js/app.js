angular.module('inquisitor.service', [])
    ...
    .value('Analyzer', {
        ...
        ,'lowercase_keyword','lowercase_keyword_ngram_min_size1','lowercase_keyword_ngram_min_size2','lowercase_keyword_ngram_min_size3','lowercase_keyword_ngram','lowercase_keyword_without_standard','lowercase_whitespace','smartcn','index_ansj','query_ansj'
    ...
    .value('Tokenizer', {
        ...
        ,'my_pinyin','pinyin_first_letter','pinyin',
        'semicolon_spliter','pct_spliter','s2t_convert','t2s_convert'
